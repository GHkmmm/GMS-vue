<template>
 <div>
 <button class="btn btn-outline-success" onclick="document.getElementById('modalManage').style.display='block'" style="width:auto;">新增交易</button>
...
<div id="modalManage" class="modal">
    <div class="modal-content animate">
        ...
        <div class="container">
            ...
            <button  class="btn btn-outline-primary my-btn" @click="addTrading()" onclick="document.getElementById('modalManage').style.display='none'">确认</button>

            <button  class="btn btn-outline-primary my-btn" onclick="document.getElementById('modalManage').style.display='none'">取消</button>
        </div>
